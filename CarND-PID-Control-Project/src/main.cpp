...
int main() {
  ...
  //pid_s.Init(0.13,0.00,1.0);
  //pid_t.Init(0.1,0.002,0.0);
  pid_st.Init(0.2,0.00,1.0);
  pid_th.Init(0.12,0.001,0.0);
  
  //th.Init(0.1,0.001,0.002);
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          steer_value = pid_st.Correction(steer_value);
          
          double des_speed = 25;
          double err_speed = speed - des_speed;
          pid_th.UpdateError(err_speed);
          speed_value = pid_th.TotalError();
          speed_value = pid_th.Correction(speed_value);
